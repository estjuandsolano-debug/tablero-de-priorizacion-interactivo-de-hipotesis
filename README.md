...
const seedData = [
  {
    id:"H-01",
    fase:"testear",
    causa:"Si promovemos un acceso responsable y controlado a las plataformas de apuestas deportivas, entonces se reducira el juego problematico entre los jovenes del grupo focal estudiado.",
    insight:"En el grupo focal, los jovenes que reportan usar mas herramientas de control de la plataforma (limites de deposito, limites de tiempo, cierre automatico de sesion) tienden a mostrar menor severidad de sintomas de juego problematico.",
    metrica:"IRSV = (Asociacion acceso-severidad = corr(controlled_access_level_score, problem_gambling_severity_index)",
    impacto:"alto",
    esfuerzo:"bajo",
    estado:"a",
    patron:"r <= -0.3",
    refutacion:"r >= -0.1",
    accionConfirma:"Fortalecer y priorizar las herramientas de control de acceso como estrategia central de intervencion.",
    accionRefuta:"Explorar otros mecanismos (educacion, publicidad responsable) ademas de solo controles de acceso.",
    valorUsuario:"Mayor sensacion de control sobre su comportamiento de apuesta y menor riesgo de desarrollar juego problematico, dentro del grupo focal estudiado.",
    riesgo:"Es un resultado correlacional, no causal: podria ser que quienes ya tienen menor severidad de juego problematico sean los que mas usan las herramientas de control (causalidad inversa), no al reves. Ademas, n=11 es una muestra muy pequena para confiar en el patron sin validarlo con mas datos."
  },
  {
    id:"H-02",
    fase:"empatizar",
    causa:"Si fomentamos publicidad responsable sobre apuestas deportivas, entonces se reducira la normalizacion y el juego problematico entre los jovenes del grupo focal estudiado.",
    insight:"No aplica todavia - el instrumento actual no incluyo preguntas sobre exposicion a publicidad de apuestas.",
    metrica:"% de jovenes expuestos a publicidad responsable con reduccion en el indice de juego problematico",
    impacto:"alto",
    esfuerzo:"alto",
    estado:"r",
    patron:">= 50% de los jovenes expuestos a publicidad responsable muestran reduccion en su indice de juego problematico",
    refutacion:"< 20% de los jovenes expuestos a publicidad responsable muestran reduccion en su indice de juego problematico",
    accionConfirma:"Recomendar a las plataformas o entes reguladores incluir mensajes de riesgo/juego responsable en su publicidad, como medida de prevencion dirigida a jovenes.",
    accionRefuta:"Descartar la publicidad responsable como palanca principal y enfocar recursos en otras estrategias (ej. controles de acceso, educacion directa).",
    valorUsuario:"Pendiente - se definira una vez se recolecte el dato.",
    riesgo:"No existe ninguna variable de exposicion a publicidad en el instrumento actual. Si se agrega en una futura recoleccion, existe riesgo de sesgo de deseabilidad social: los jovenes podrian subreportar cuanta publicidad de apuestas ven realmente."
  },
  {
    id:"H-03",
    fase:"testear",
    causa:"Si un joven que apuesta en plataformas deportivas tiene mayor conciencia y autopercepcion de su propia capacidad para dejar de apostar cuando lo desea, entonces presentara menor severidad de juego problematico asociado a las apuestas deportivas.",
    insight:"En el grupo focal, quienes reportan mayor capacidad de autocontrol percibida muestran menor severidad de sintomas de juego problematico.",
    metrica:"corr(capacidad_autocontrol_percibida, problem_gambling_severity_index)",
    impacto:"medio",
    esfuerzo:"bajo",
    estado:"a",
    patron:"r <= -0.3 ",
    refutacion:"r >= -0.1",
    accionConfirma:"Incluir el autocontrol percibido como indicador temprano en futuras intervenciones con este grupo.",
    accionRefuta:"Descartar el autocontrol percibido como proxy util de conciencia de riesgo.",
    valorUsuario:"Indicador facil de medir para detectar riesgo temprano dentro del grupo focal.",
    riesgo:"Es una reformulacion de la hipotesis original sobre conciencia de riesgo/normalizacion, no la misma pregunta - riesgo de que se interprete como si respondiera esa hipotesis original cuando mide un constructo distinto. Tambien aplica riesgo de sesgo de autoreporte: la persona puede sobreestimar su propia capacidad de control."
  }
];
